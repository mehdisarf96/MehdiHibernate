...
public class InsertMain {
    ...
    public static void main(String[] args) {
        ...
        // va be ezaye inha, recordi be table e 'person_address' (ke nash'at gerefte az
        // @ManyToOne va @JoinTable e class e Address hast) ezafe va store nemishe.
        // chera? chon to alan on Person side umadi karet ro anjam dadi
